...
const Penguin = ({ }) => {
    ...
    async function playSound() {
        ...
        const { sound } = await Audio.Sound.createAsync(require('../Media/fox_song.mp3'));
        setSound(sound);
    ...
    const images = [
        { id: 1, source: require('../img/foxbaby.jpeg') },
        { id: 2, source: require('../img/foxbaby2.jpeg') },
        { id: 3, source: require('../img/foxbaby3.jpeg') },
        { id: 4, source: require('../img/foxbaby4.jpeg') },
        { id: 5, source: require('../img/foxbaby5.jpeg') },
    ];
        ...
        <View>
            ...
            <View style={styles.activitySection1}>
                <View style={styles.textStyle}>
                    <Text style={{ fontSize: 24, fontWeight: 'bold', color: 'black', zIndex: 2 }}>Fox</Text>
                    <View style={{ width: 100, height: 16, backgroundColor: '#FFF2C5', borderRadius: 10, zIndex: 1, top: -14 }}></View>
                </View>
                <View style={styles.app}>
                    ...
                    <AntDesign name={icon} size={30} color="#60969D" onPress={() => toggleHeight()}/>
                        ...
                        <View style={styles.textStyle2}>
                            ...
                            <Text style={{ fontSize: 21, fontWeight: 'bold', color: 'black' }}>仙境狐狸館</Text>
                        </View>
                            ...
                            <>
                                <Animated.View style={[styles.imgArrange1, textOpacityAnimation]}>
                                    ...
                                    <View style={styles.textsection2}>
                                        <Text style={{ fontSize: 16, fontWeight: '500', color: 'black' }}>1. 狐和狼、豺等相比體形要小一些。</Text>
                            <Text style={{ fontSize: 16, fontWeight: '500', color: 'black' }}>2. 毛髮通常呈橙、啡、灰、白色。</Text>
                            <Text style={{ fontSize: 16, fontWeight: '500', color: 'black' }}>3. 狐狸對伴侶十分忠誠，即使伴侶死後，也不會找其他狐。</Text>
                                    </View>
                                </Animated.View>
                                <Animated.View style={[styles.activitySection1, textOpacityAnimation]}>
                                <View style={styles.musicbox}>
                    <Image
                        source={require('../img/fox_song.jpeg')}
                        style={styles.activitImg1} />
                    <View style={styles.textsection}>
                        <Text style={{ fontSize: 16, fontWeight: '500', color: 'black',marginRight:10 }}>What Does The Fox Say?</Text>
