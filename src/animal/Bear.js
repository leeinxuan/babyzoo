...
const Detail = ({ }) => {
    ...
    const toggleHeight = () => {
        ...
        setIcon(prevIcon => prevIcon === "downcircleo" ? "upcircleo" : "downcircleo");
    };
    ...
    const images = [
        { id: 1, source: require('../img/bearbaby.png') },
        { id: 2, source: require('../img/bearbaby2.jpeg') },
        { id: 3, source: require('../img/bearbaby3.jpeg') },
        { id: 4, source: require('../img/bearbaby4.jpeg') },
        { id: 5, source: require('../img/bearbaby5.jpeg') },
    ];
                ...
                <View style={styles.app}>
                    <Animated.View style={[styles.box, boxAnimation]}>
                        ...
                        <View style={styles.textStyle2}>
                            ...
                            <Text style={{ fontSize: 21, fontWeight: 'bold', color: 'black' }}>美極棕熊館</Text>
                        </View>
                                ...
                                <Animated.View style={[styles.imgArrange1, textOpacityAnimation]}>
                                    <View style={styles.textsection3}>
                                        <Text style={{ fontSize: 16, fontWeight: '500', color: 'black', left: -12 }}>
                                            遍布於亞洲、非洲的阿特拉斯山脈、歐洲和北美洲。現在棕熊在許多地方都已滅絕，全球種群數量約在20萬只左右。
                                        </Text>
                                    </View>
