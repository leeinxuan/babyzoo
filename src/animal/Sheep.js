...
const Penguin = ({ }) => {
    ...
    async function playSound() {
        ...
        const { sound } = await Audio.Sound.createAsync(require('../Media/SHEEP.mp3'));
        setSound(sound);
    ...
    const images = [
        { id: 1, source: require('../img/sheepbaby.png') },
        { id: 2, source: require('../img/sheepbaby2.jpeg') },
        { id: 3, source: require('../img/sheepbaby3.jpeg') },
        { id: 4, source: require('../img/sheepbaby4.jpeg') },
        { id: 5, source: require('../img/sheepbaby5.jpeg') },
    ];
        ...
        <View>
            ...
            <View style={styles.activitySection1}>
                <View style={styles.textStyle}>
                    <Text style={{ fontSize: 24, fontWeight: 'bold', color: 'black', zIndex: 2 }}>Lama Pacos</Text>
                ...
                <View style={styles.app}>
                    ...
                    <AntDesign name={icon} size={30} color="#60969D" onPress={() => toggleHeight()}/>
                        ...
                        <View style={styles.textStyle2}>
                            ...
                            <Text style={{ fontSize: 21, fontWeight: 'bold', color: 'black' }}>草極羊駝館</Text>
                        </View>
                            ...
                            <>
                                <Animated.View style={[styles.imgArrange1, textOpacityAnimation]}>
                                    <View style={styles.textsection3}>
                                        ...
                                        約90%以上生活在南美洲的祕魯及智利的高原上，其餘分佈於澳洲的維多利亞州和新南威爾斯州，以及紐西蘭。
                                        </Text>
                                    </View>
                                    ...
                                    <View style={styles.textsection2}>
                                        <Text style={{ fontSize: 16, fontWeight: '500', color: 'black' }}>1. 俗稱草泥馬，屬偶蹄目駱駝科。</Text>
                            <Text style={{ fontSize: 16, fontWeight: '500', color: 'black' }}>2. 牠們主要通過身體姿勢和柔和的哼唱聲進行交流。。</Text>
                            <Text style={{ fontSize: 16, fontWeight: '500', color: 'black' }}>3. 許多人混淆，誤以為羊駝新分類的小羊駝屬別稱為駱馬屬。</Text>
                                    </View>
                                </Animated.View>
                                <Animated.View style={[styles.activitySection1, textOpacityAnimation]}>
                                <View style={styles.musicbox}>
                    <Image
                        source={require('../img/sheep_song.jpeg')}
                        style={styles.activitImg1} />
                    <View style={styles.textsection}>
                        <Text style={{ fontSize: 16, fontWeight: '500', color: 'black',marginLeft:50, }}>SHEEP</Text>
