    ...
    return (
        <View>
            <View style={styles.imgArrange}>
                ...
                <VStack>
                    <Image
                        source={require('../img/foxbaby2.jpeg')}
                        style={styles.activitImg} />
                </VStack>
                <VStack>
                    <Image
                        source={require('../img/foxbaby3.jpeg')}
                        style={styles.activitImg} />
                </VStack>
            </View>
            <View style={styles.activitySection1}>
                ...
                <View style={styles.textStyle2}>
                    ...
                    <Text style={{ fontSize: 21, fontWeight: 'bold', color: 'black', zIndex: 2, top: 20 }}>仙境狐狸館</Text>
                ...
                <View style={styles.imgArrange1}>
                    <VStack>
                        <View style={styles.textsection3}>
                            <Text style={{ fontSize: 16, fontWeight: '500', color: 'black', }}>原產於舊大陸的種類實際上分布於整個歐洲，溫帶亞洲和北非。</Text>
                        </View>
                    </VStack>
                    <VStack>
