    ...
    return (
        <View>
            <View style={styles.imgArrange}>
                ...
                <VStack>
                    <Image
                        source={require('../img/minkbaby2.jpeg')}
                        style={styles.activitImg} />
                </VStack>
                <VStack>
                    <Image
                        source={require('../img/minkbaby3.jpeg')}
                        style={styles.activitImg} />
                </VStack>
            </View>
            <View style={styles.activitySection1}>
                ...
                <View style={styles.textStyle2}>
                    ...
                    <Text style={{ fontSize: 21, fontWeight: 'bold', color: 'black', zIndex: 2, top: 20 }}>軟萌雪貂館</Text>
                ...
                <View style={styles.imgArrange1}>
                    <VStack>
                        <View style={styles.textsection3}>
                            <Text style={{ fontSize: 16, fontWeight: '500', color: 'black', }}>雪貂的馴養歷史不明，但很有可能是早於2500年前就已經開始。</Text>
                        </View>
                    </VStack>
                    <VStack>
