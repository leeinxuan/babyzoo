    ...
    return (
        <View>
            <View style={styles.imgArrange}>
                ...
                <VStack>
                    <Image
                        source={require('../img/capybarababy2.jpeg')}
                        style={styles.activitImg} />
                </VStack>
                <VStack>
                    <Image
                        source={require('../img/capybarababy3.jpeg')}
                        style={styles.activitImg} />
                </VStack>
            </View>
            <View style={styles.activitySection1}>
                ...
                <View style={styles.textStyle2}>
                    ...
                    <Text style={{ fontSize: 21, fontWeight: 'bold', color: 'black', zIndex: 2, top: 20 }}>慈祥水豚館</Text>
                ...
                <View style={styles.imgArrange1}>
                    <VStack>
                        <View style={styles.textsection3}>
                            <Text style={{ fontSize: 16, fontWeight: '500', color: 'black', }}>原產於南美洲除了智利以外的所有稀樹草原和叢林中。</Text>
                        </View>
                    </VStack>
                    <VStack>
