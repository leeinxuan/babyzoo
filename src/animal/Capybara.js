...
const Penguin = ({ }) => {
    ...
    async function playSound() {
        ...
        const { sound } = await Audio.Sound.createAsync(require('../Media/Capybara_Song.mp3'));
        setSound(sound);
    ...
    const images = [
        { id: 1, source: require('../img/capybarababy.jpeg') },
        { id: 2, source: require('../img/capybarababy2.jpeg') },
        { id: 3, source: require('../img/capybarababy3.jpeg') },
        { id: 4, source: require('../img/capybarababy4.jpeg') },
        { id: 5, source: require('../img/capybarababy5.jpeg') },
    ];
        ...
        <View>
            ...
            <View style={styles.activitySection1}>
                <View style={styles.textStyle}>
                    <Text style={{ fontSize: 24, fontWeight: 'bold', color: 'black', zIndex: 2 }}>Capybara</Text>
                ...
                <View style={styles.app}>
                    ...
                    <AntDesign name={icon} size={30} color="#60969D" onPress={() => toggleHeight()}/>
                        ...
                        <View style={styles.textStyle2}>
                            ...
                            <Text style={{ fontSize: 21, fontWeight: 'bold', color: 'black' }}>慈祥水豚館</Text>
                        </View>
                            ...
                            <>
                                <Animated.View style={[styles.imgArrange1, textOpacityAnimation]}>
                                    ...
                                    <View style={styles.textsection2}>
                                        <Text style={{ fontSize: 16, fontWeight: '500', color: 'black' }}>1. 牠是一種半水棲的食草動物。</Text>
                            <Text style={{ fontSize: 16, fontWeight: '500', color: 'black' }}>2. 世界上體型最大的齧齒類動物。</Text>
                            <Text style={{ fontSize: 16, fontWeight: '500', color: 'black' }}>3. 水豚是高度社會化的動物，最大的水豚群數量可達100頭。</Text>
                                    </View>
                                </Animated.View>
                                <Animated.View style={[styles.activitySection1, textOpacityAnimation]}>
                                <View style={styles.musicbox}>
                    <Image
                        source={require('../img/capybara_song.jpeg')}
                        style={styles.activitImg1} />
                    <View style={styles.textsection}>
                        <Text style={{ fontSize: 16, fontWeight: '500', color: 'black', marginLeft:15}}>Capybara Song</Text>
