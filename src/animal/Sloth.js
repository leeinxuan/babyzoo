...
const Penguin = ({ }) => {
    ...
    async function playSound() {
        ...
        const { sound } = await Audio.Sound.createAsync(require('../Media/The_Lazy_Song.mp3'));
        setSound(sound);
    ...
    return (
        <View>
            <View style={styles.imgArrange}>
                ...
                <VStack>
                    <Image
                        source={require('../img/slothbaby2.jpeg')}
                        style={styles.activitImg} />
                </VStack>
                <VStack>
                    <Image
                        source={require('../img/slothbaby3.jpeg')}
                        style={styles.activitImg} />
                </VStack>
            </View>
            <View style={styles.activitySection1}>
                <View style={styles.textStyle}>
                    <Text style={{ fontSize: 24, fontWeight: 'bold', color: 'black', zIndex: 2 }}>Sloth</Text>
                ...
                <View style={styles.textStyle2}>
                    ...
                    <Text style={{ fontSize: 21, fontWeight: 'bold', color: 'black', zIndex: 2, top: 20 }}>慢慢樹懶館</Text>
                ...
                <View style={styles.imgArrange1}>
                    <VStack>
                        <View style={styles.textsection3}>
                            <Text style={{ fontSize: 16, fontWeight: '500', color: 'black', }}>共有兩科六種，分布於南美洲及中美洲的熱帶雨林中。</Text>
                        </View>
                    </VStack>
                    <VStack>
                    ...
                    <VStack>
                        <View style={styles.textsection2}>
                            <Text style={{ fontSize: 16, fontWeight: '500', color: 'black' }}>1. 移動速度非常慢，每分鐘4米。</Text>
                            <Text style={{ fontSize: 16, fontWeight: '500', color: 'black' }}>2. 樹懶的粗毛夾縫中長有與其互利共生的綠藻，提供很好的保護色。</Text>
                            <Text style={{ fontSize: 16, fontWeight: '500', color: 'black' }}>3. 被稱為二趾與三趾樹懶，但其實現存的樹懶均有3根腳趾。</Text>
                        </View>
                    </VStack>
                </View>
            </View>
            <View style={styles.activitySection}>
                <View style={styles.musicbox}>
                    <Image
                        source={require('../img/wallpaper_song.jpeg')}
                        style={styles.activitImg1} />
                    <View style={styles.textsection}>
                        <Text style={{ fontSize: 16, fontWeight: '500', color: 'black',marginLeft: 15, }}>The Lazy Song</Text>
