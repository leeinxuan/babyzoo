...
const Penguin = ({ }) => {
    ...
    const images = [
        { id: 1, source: require('../img/penguinbaby.jpeg') },
        { id: 2, source: require('../img/penguinbaby2.jpeg') },
        { id: 3, source: require('../img/penguinbaby3.jpeg') },
        { id: 4, source: require('../img/penguinbaby4.jpeg') },
        { id: 5, source: require('../img/penguinbaby5.jpeg') },
    ];
                ...
                <View style={styles.app}>
                    ...
                    <AntDesign name={icon} size={30} color="#60969D" onPress={() => toggleHeight()}/>
                        ...
                        <View style={styles.textStyle2}>
                            ...
                            <Text style={{ fontSize: 21, fontWeight: 'bold', color: 'black' }}>南極企鵝館</Text>
                        </View>
